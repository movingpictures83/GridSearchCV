...
class GridSearchCVPlugin:
    ...
    def output(self, outputfile):
        ...
        ridge_params = {'alpha':[50,200, 230, 250,265, 270, 275, 290, 300, 500]}
        clf = GridSearchCV(Ridge(), param_grid=ridge_params).fit(X_train_rfe, y_train_rfe).best_estimator_
